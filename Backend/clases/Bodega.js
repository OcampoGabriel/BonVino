...
const bodegas = [
    ...
    new Bodega(4, '-31.424014,-64.497780', 'Los Jeroldos', 'Una bodega familiar en Córdoba, conocida por sus vinos de excelente calidad', 'Los Jeroldos fue fundada en 1950 por Jeroldo Basso, un inmigrante italiano que soñaba con hacer el mejor vino de Argentina.', 5, new Date(2024, 3, 8)),
    new Bodega(5, '-27.593500,-48.558540', 'Costa Verde', 'Una bodega que produce vinos blancos y espumosos.', 'Costa Verde fue fundada en 1970 por la familia Costa, que ha estado haciendo vino en Brasil durante tres generaciones.', 6, new Date(2024, 1, 23)),
    new Bodega(6, '-34.651462,-71.657269', 'Valle Central', 'Una bodega extraordinaria, muy amada por los críticos.', 'Valle Central fue fundada en 1900 por la familia Valle, que ha estado cultivando uvas en Chile durante más de un siglo.', 2, new Date(2024, 2, 4)),
    new Bodega(7, '-34.603722,-58.381592', 'Ciudad Autónoma', 'Una bodega urbana, conocida por sus vinos blancos.', 'Ciudad Autónoma fue fundada en 2000 y es una de las pocas bodegas urbanas de Argentina.', 4, new Date(2024, 3, 25)),
    new Bodega(8, '-22.906847,-43.172896', 'Rio de Janeiro', 'Una bodega en Rio de Janeiro que produce vinos blancos y espumosos.', 'La bodega fue fundada en 1980 por la familia de Janeiro, que ha estado haciendo vino en Brasil durante dos generaciones.', 3, new Date(2024, 2, 1)),
