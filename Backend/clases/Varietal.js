export class Varietal {
    constructor(descripcion, composicion, uva) {
        ...
        Varietal.varietales.push(this);
    }

    // Metodo del varietal que le permite responder si es el mismo que se paso por parametro
...
export let varietales = Varietal.varietales;